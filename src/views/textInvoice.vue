<template>
<body>
    <button class="waves-effect waves-light" @click="download">Generate Invoice</button>
    <div id="invoice" ref="invoiceContents">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="invoice-title">
                        <h2>Invoice</h2>
                        <h3 class="pull-right">Order No: fgh123-j</h3>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-xs-6">
