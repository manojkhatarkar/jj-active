<template>
  ...
  <div class="card">
    ...
    <h1 class="color-green-bold">Order successfully placed</h1>
    <h1 class="card__msg">Payment Complete</h1>
    <h2 class="card__submsg">Thank you for your transfer</h2>
    <!-- <h2 class="card__submsg">Your Order Id Is {{this.$route.params.name}} </h2> -->
    <router-link :to="{ name: 'Home'}" class="btn btn-success">Go Back to Home</router-link>
  </div>
